...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button relative flex w-full min-w-0 items-center gap-2 rounded-md px-2 outline-none ring-sidebar-ring transition-colors focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
